...
<jsp:useBean id="stages" scope="request" type="java.util.List<com.oneandone.sales.tools.stool.overview.StageInfo>"/>
<c:forEach var="stage" items="${stages}">
    <tr id="${stage.name}" data-hash="${stage.hash}" data-extractionurl="${stage.extractionUrl}" data-user="${stage.owner}"
        ...
        <td class="until ${stage.until.expired() ? "expired" : ""}">${stage.until}</td>
