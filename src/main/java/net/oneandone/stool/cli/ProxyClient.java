...
public class ProxyClient extends Client {
    ...
    @Override
    public Map<String, String> create(String stageName, ClassRef applicationRef, Map<String, String> values) throws IOException {
        HttpNode node;
    ...
    @Override
    public Diff publish(String stage, boolean dryrun, String allow, ClassRef applicationRef, Map<String, String> values) throws IOException {
        HttpNode node;
