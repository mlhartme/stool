...
public abstract class Client {
    ...
    public abstract Map<String, Map<String, String>> getValues(String stage) throws IOException;
    ...
    public abstract List<String> describe(String ref) throws Exception;
}
