...
import net.oneandone.sales.tools.stool.EnumerationFailed;
import net.oneandone.sales.tools.stool.configuration.Bedroom;
...
import net.oneandone.sales.tools.stool.setup.Install;
