...
public abstract class Client {
    ...
    public abstract Map<String, String> create(String stageName, ApplicationRef applicationRef, Map<String, String> values) throws IOException;

    public abstract Diff publish(String stage, boolean dryrun, String allow, ApplicationRef applicationRef, Map<String, String> values) throws IOException;
